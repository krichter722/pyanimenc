...
class MainWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        auto_src_label = Gtk.Label('Source')
        auto_src_label.set_halign(Gtk.Align.START)
        auto_vid_label = Gtk.Label('Video')
        auto_vid_label.set_halign(Gtk.Align.START)
        auto_aud_label = Gtk.Label('Audio')
        auto_aud_label.set_halign(Gtk.Align.START)
        ...
        input_grid.attach(auto_label, 4, 0, 3 ,1)
        input_grid.attach(auto_src_label, 4, 1, 1, 1)
        input_grid.attach_next_to(self.auto_src_fcbutton, auto_src_label,
                                  Gtk.PositionType.RIGHT, 1, 1)
        input_grid.attach_next_to(auto_sconf_button, self.auto_src_fcbutton,
                                  Gtk.PositionType.RIGHT, 1, 1)
        input_grid.attach(auto_vid_label, 4, 2, 1, 1)
        input_grid.attach_next_to(self.auto_venc_cbtext, auto_vid_label,
                                  Gtk.PositionType.RIGHT, 1, 1)
        input_grid.attach_next_to(auto_vconf_button, self.auto_venc_cbtext,
                                  Gtk.PositionType.RIGHT, 1, 1)
        input_grid.attach(auto_aud_label, 4, 3, 1, 1)
        input_grid.attach_next_to(self.auto_aenc_cbtext, auto_aud_label,
                                  Gtk.PositionType.RIGHT, 1, 1)
        input_grid.attach_next_to(auto_aconf_button, self.auto_aenc_cbtext,
                                  Gtk.PositionType.RIGHT, 1, 1)
        input_grid.attach(self.auto_queue_button, 4, 4, 3, 1)
        input_grid.attach(hsep, 0, 5, 7, 1)
